...
namespace MyNewShop.Controllers
{
    public class CountriesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddState(StateVM model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddCity(CityVM model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditState(int id, StateVM model)
        {
            if (id != model.Id)
            {
                return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditCity(int id, CityVM model)
        {
            if (id != model.Id)
            {
                return NotFound();
